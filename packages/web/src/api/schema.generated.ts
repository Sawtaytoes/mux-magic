export interface paths {
    ...
    "/commands/copyAudioReleaseDateIntoDate": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: {
            ...
            requestBody?: {
                content: {
                    "application/json": {
                        /**
                         * @description Report matching files without writing tags.
                         * @default true
                         */
                        isDryRun?: boolean;
                        /**
                        ...
                        isRecursive?: boolean;
                        /**
                         * @description Restore each file's modified time after writing. On by default so the library scanner does not treat each repaired album as new.
                         * @default true
                         */
